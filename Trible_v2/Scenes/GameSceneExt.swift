...
//        cameraNode.addChild(node)
        ...
        node.setScale(0.7)
        node.zPosition = 50.0
        node.position = CGPoint(x: -width/2.0 + node.frame.width*i + j - 15.0, y: playableRect.height/2)
        cameraNode.addChild(node)
    }
...
//        cameraNode.addChild(pauseNode)
        ...
        pauseNode.zPosition = 50.0
        pauseNode.name = "pause"
        pauseNode.position = CGPoint(x: playableRect.width/2 - pauseNode.frame.width, y: playableRect.height/2)
        cameraNode.addChild(pauseNode)
    }
    ...
    func setupControl() {
        ...
        // ganti
        jumpArrow.position = CGPoint(x: playableRect.width/2 - pauseNode.frame.width, y: -playableRect.width/3 + jumpArrow.frame.height/2.0)
